...
Data$poutcome <- replace(Data$poutcome, Data$poutcome=="unknown", "no")
Data$contact <- replace(Data$contact, Data$contact=="unknown", NA)
Data$education <- replace(Data$education, Data$education=="unknown", NA)
Data$job <- replace(Data$job, Data$job=="unknown", NA)
